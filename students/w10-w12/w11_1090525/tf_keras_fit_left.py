...
model.add(tf.keras.layers.Dropout(0.2, name='layers_dropout_1'))
#layer4
model.add(tf.keras.layers.Dense(units=64, kernel_initializer='normal',activation='relu', name='layers_dense_3')) 
model.add(tf.keras.layers.Dropout(0.2, name='layers_dropout_2'))
# Add output layer
model.add(tf.keras.layers.Dense(units=10,  kernel_initializer='normal',activation='softmax', name='layers_dense_4'))
